...
.succWrap{
    ...
    <body>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                       <h1> <div class="page-title"style="background-color:rgba(255,99 ,71);">Manage Employees</div></h1>
                    </div>
                    ...
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                ...
                                <table id="example" class="display responsive-table "style="background-color:rgba(255,99 ,71);">
                                    <thead>
                                        <tr>
                                            <th>Sr no</th>
                                            <th>Emp Id</th>
