              ...
              <i class="fa fa-angle-left pull-right"></i>
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="approvedleave-history.php"><i class="fa fa-circle-o"></i>Approved Leaves</a></li>
                                  <li><a href="notapproved-leaves.php"><i class="fa fa-circle-o"></i>Not Approved Leaves</a></li>
								   <li><a href="addleavetype.php"><i class="fa fa-circle-o"></i>Add Leave Type</a></li>
                                <li><a href="manageleavetype.php"><i class="fa fa-circle-o"></i>Manage Leave Type</a></li>
